...
include("LuaRules/Gadgets/craig/genetic_algorithm.lua")
...
function AddPathFinderCheckCommand()
	local cmd,func,help
	cmd  = "pathcheck"
	func = PathFinder.ConnectTest
	help = " simple pathinder-over-graph test"
	gadgetHandler:AddChatAction(cmd,func,help)
end
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
